// Species flags.	//WHY IS THIS NOT IN DNA??
...
#define DIGITIGRADE			(1<<11)		// Use Digitigrade leg sprites. Don't give it to other races unless you make sprites for this (see r_vulpkanin.dmi)
// absolute limit: (1<<20) - higher than this will overflow into expenentials. - Pooj
